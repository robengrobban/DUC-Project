...
const abi = JSON.parse(await fs.readFile("contracts/"+ContractName+".abi", "utf-8"));
const bytecode = "0x" + await fs.readFile("contracts/"+ContractName+".bin", "utf-8");
...
fs.writeFile("contracts/"+ContractName+".address", contract_address, "utf-8");